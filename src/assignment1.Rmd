...
knit: (function(inputFile, encoding){ 
    out_dir <- '../';
    rmarkdown::render(inputFile, encoding = encoding, output_file=file.path(dirname(inputFile), out_dir, 'assignment1.pdf')) 
  })
---
...
```{r, warning=F, message=F, results='hide', include=FALSE}
# Export PDF
pdf("../ess575_assignment1_GWoolsey.pdf", paper = "USr", height = 8.5, width = 11)
print(my_plot)
dev.off()  
